...
struct WikiView: View {
    ...
    private var entries: [WikiEntry] {
        ...
        case .threats:
            return [
                WikiEntry(icon: "hexagon.fill", eyebrow: "KINETIC", title: "Asteroids", detail: "Heavy debris ricochets from arena walls and solid geometry. Its mineral shell, rotation and impact trail reveal its path before contact.", facts: ["Freeze stops every asteroid", "Surge can help outrun a rebound"], tint: .orange),
    ...
    private var abilityEntries: [WikiEntry] {
        [
            WikiEntry(icon: "snowflake", eyebrow: "CONTROL · 3.2 SEC · 11 SEC COOLDOWN", title: "Freeze", detail: "Locks the whole hostile simulation: asteroids, rifts, moving walls, laser phase and Echo playback all stop for the duration.", facts: ["Every active asteroid freezes", "Cryostasis extends the duration"], tint: EchoTheme.cyan),
