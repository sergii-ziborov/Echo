...
| Volcanic, glowing, cracked | Magma core: a dark crust split by glowing fissures and hot spots; it bursts into cooling embers. |
| Porous, layered, crystal-lined | Hollow geode: sandy banded stone with violet crystal pockets; it splits quickly. |
| Metallic, pitted, rusty | Meteoric iron: thumbprint dents, rust and one polished face with crossing bands; the toughest shell that still breaks, and it throws sparks. |
| Frozen, dusty, trailing | Comet frost: a dusty snowball with venting jets and a vapour trail; its first impact dooms it. |
